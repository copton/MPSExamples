...
<model modelUID="r:ffe5aeba-775f-485f-ae39-3493664a308b(AkcConfig.sandbox.sandbox)">
  ...
  <node type="AkcConfig.structure.Environment" id="7849759035719631997">
    <node role="rules" type="AkcConfig.structure.EnterRule" id="7849759035719642539">
      <link role="location" targetNodeId="7849759035719631998" resolveInfo="Bridge" />
      <node role="sets" type="AkcConfig.structure.BasicSetRef" id="7849759035719648610">
        <link role="set" targetNodeId="7849759035719637332" resolveInfo="Knight" />
      </node>
      <node role="actions" type="AkcConfig.structure.ActionRef" id="7849759035719648606">
